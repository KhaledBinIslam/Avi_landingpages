...
function bcsirbtn() {
    var x = document.getElementById("bcsir-btn");
...
function emailSend() {
    ...
    Email.send({
        ...
        Username: "neturalhub@gmail.com",
        Password: "DF82577CCB22E250ED74E2EEC371415A91AA",
        To: 'neturalhub@gmail.com',
        From: "neturalhub@gmail.com",
        Subject: "This is The Natural Hub order",
        Body: messageBody
    }).then(
        message => {
            if (message == 'OK') {
